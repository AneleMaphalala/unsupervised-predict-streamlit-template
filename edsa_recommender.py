...
def main():
    ...
    page_options = ["Recommender System", "Solution Overview",  "About", "Contact Us",  "For The Tech Geeks",  "FAQ"]
    ...
    if page_selection == "FAQ":
        ...
        st.write("A: The Intelliscape Analytics app is designed to make recommendations tailored to each user’s needs and preferences, providing a better viewing experience.")
        ...
        st.write("A: Yes,  the Intelliscape Analytics app is free to download and use.")
